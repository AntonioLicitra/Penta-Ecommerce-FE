...
<!-- <div class="flex items-center">
    ...
    <header> 
        ...
        <RouterLink to="/" class="text-grande"><svg class="w-[60px]"  viewBox="0 0 500 500" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                    ...
                                                    <path d="M273 28.6999C250.6 14.8999 221.1 21.5999 207.3 43.9999C207.3 44.1999 207.1 44.4 206.9 44.4L7.2001 405.7C-6.6999 428.1 0.200104 457.5 22.5001 471.4C30.0001 476.1 38.8001 478.5 47.6001 478.4C64.2001 478.5 79.6001 469.9 88.1001 455.6L287.9 94.2999C301.9 72.0999 295.2 42.6999 273 28.6999Z" fill="#294F94"/>
        ...
        <div class="flex  ">
            ...
            <div class="relative sm:w-60 flex items-center mr-[-20px] sm:mr-0">
                ...
                <input type="text" class="hidden md:block w-full border h-12 shadow p-4 rounded-full" placeholder="Search...">
            ...
            <CartView v-if="cartShow" @close-cart="showCart" @checkout="showCart"></CartView>
              ...
              <!-- menù -->
              <div @click="fnMenu" v-if="men" class="ml-[23px] w-[28px] sm:hidden"><svg xmlns="http://www.w3.org/2000/svg"
                    viewBox="0 0 448 512">
                    <path
                        d="M0 96C0 78.3 14.3 64 32 64H416c17.7 0 32 14.3 32 32s-14.3 32-32 32H32C14.3 128 0 113.7 0 96zM0 256c0-17.7 14.3-32 32-32H416c17.7 0 32 14.3 32 32s-14.3 32-32 32H32c-17.7 0-32-14.3-32-32zM448 416c0 17.7-14.3 32-32 32H32c-17.7 0-32-14.3-32-32s14.3-32 32-32H416c17.7 0 32 14.3 32 32z" />
                </svg></div>
